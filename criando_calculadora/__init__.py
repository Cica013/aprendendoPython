...
class Calculadora(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.setWindowTitle('Calculadora do Cica')
        ...
        self.add_btn(
            ...
            'background: #32e59a; color: #fff; font-weight: 700;'
        )
        ...
        self.add_btn(
            ...
            'background: #020aff; color: #fff; font-weight: 700;'
        )
        ...
        self.add_btn(
            QPushButton('='), 4, 4, 1, 1,
            self.eval_igual,
            'background: #e02ab9; color: #fff; font-weight: 700;'
        )
